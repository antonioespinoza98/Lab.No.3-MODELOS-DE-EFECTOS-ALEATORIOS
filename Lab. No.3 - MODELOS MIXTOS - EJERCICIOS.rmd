...
exp(2*mod$coefficients[2])
```

+ En una parcela específica, la propensión de encontrar un macho cuando se usa lampareo es 74% mayor que cuando se usa alumbrado público. 
